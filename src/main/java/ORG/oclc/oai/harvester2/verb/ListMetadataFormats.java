...
public class ListMetadataFormats extends HarvesterVerb {
    ...
    public ListMetadataFormats(String baseURL, int timeout)
    throws IOException, ParserConfigurationException, SAXException,
    TransformerException {
        this(baseURL, null, timeout);
    }
    ...
    throws IOException, ParserConfigurationException, SAXException,
    TransformerException {
        this(baseURL, identifier, 0);
    }
    
    public ListMetadataFormats(String baseURL, String identifier, int timeout)
    throws IOException, ParserConfigurationException, SAXException,
    TransformerException {
        super(getRequestURL(baseURL, identifier), timeout);
    }
